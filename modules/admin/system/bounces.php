...
class _bounces extends \IPS\Dispatcher\Controller
{
    ...
    protected function manage()
    {
        ...
        $form->add(new \IPS\Helpers\Form\Interval('awsses_soft_bounce_interval', \IPS\Settings::i()->awsses_soft_bounce_interval, true, [
            'unlimited' => '-1',
        ...
        $form->add(new \IPS\Helpers\Form\Select('awsses_soft_bounce_action_group', \IPS\Settings::i()->awsses_soft_bounce_action_group, false, ['options' => $groups], null, null, null, 'awsses_soft_bounce_action_group'));

        // Soft Bounces
        $form->addTab('awsses_settings_tab_hard_bounces');
        $form->addMessage('awsses_settings_bounce_message', 'ipsPad ipsMessage ipsMessage_warning ipsType_reset ipsSpacer_top');
        $form->addMessage('awsses_settings_header_bounces');
        $form->add(new \IPS\Helpers\Form\Interval('awsses_hard_bounce_interval', \IPS\Settings::i()->awsses_hard_bounce_interval, true, [
            'unlimited' => '-1',
            'unlimitedLang' => 'awsses_form_process_immediately'
        ]));
        ...
        $form->add(new \IPS\Helpers\Form\Select('awsses_hard_bounce_action_group', \IPS\Settings::i()->awsses_hard_bounce_action_group, false, ['options' => $groups], null, null, null, 'awsses_hard_bounce_action_group'));
