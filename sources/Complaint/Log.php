...
namespace IPS\awsses\Complaint;
...
class _Log extends \IPS\Node\Model
{
     ...
     * @var string
     */
    public static $databaseTable = 'awsses_complaint_logs';
     ...
     * @var string
     */
    public static $nodeTitle = 'Complaint Logs';
     ...
     * @var string
     */
    public static $permType = 'complaint_log';
